    ...
    <div className='container mt-4'>
      <div className='card col-8'>
        <div className='card-body'>
          ...
          <div className='card-text'>{infothread.description} </div><br />
          <div onClick={handleClickLike}> <i className={`${heart}`}></i> {like} </div>
          <h5 className="mt-5">Comments</h5>
          
     
            <ul className="list-group list-group-flush colorComments">
              {
      ...
      <div className="col-8 text-center" >
        ...
        />
        <button className="btn m-3 " onClick={handleClick}>Share comment</button>
